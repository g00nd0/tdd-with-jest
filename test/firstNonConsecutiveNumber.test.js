...
test("array should return 3", function () {
  expect(firstNonConsecutiveNumber([1, 3])).toEqual(16);
});

test("array should return 4", function () {
  expect(firstNonConsecutiveNumber([1, 2, 4, 5, 6])).toEqual(5);
});

test("array should return -10", function () {
  expect(firstNonConsecutiveNumber([-1, 0, 1, -10])).toEqual(5);
});

test("array should return null", function () {
  expect(firstNonConsecutiveNumber([1, 2, 3, 4, 5, 6])).toEqual(5);
});
